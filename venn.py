...
def venn2(data=None, names=None, show_names=True, show_plot=True, **kwds):
    ...
    ## draw text
    # 1
    plt.text(x1 - r / 2, y1, labels['10'], **alignment)
    plt.text(x2 + r / 2, y2, labels['01'], **alignment)
    # 2
    plt.text((x1 + x2) / 2, y1, labels['11'], **alignment)
    # names of different groups
    if show_names:
        plt.text(x1, y1 - 1.2 * r, names[0], fontsize=16, **alignment)
        plt.text(x2, y2 - 1.2 * r, names[1], fontsize=16, **alignment)
...
def venn3(data=None, names=None, show_names=True, show_plot=True, **kwds):
    ...
    ## draw text
    # 1
    plt.text(x1 - r / 2, y1 - r / 2, labels['100'], **alignment)
    plt.text(x2 + r / 2, y2 - r / 2, labels['010'], **alignment)
    plt.text((x1 + x2) / 2, y3 + r / 2, labels['001'], **alignment)
    # 2
    plt.text((x1 + x2) / 2, y1 - r / 2, labels['110'], **alignment)
    plt.text(x1, y1 + 2 * r / 3, labels['101'], **alignment)
    plt.text(x2, y2 + 2 * r / 3, labels['011'], **alignment)
    # 3
    plt.text((x1 + x2) / 2, y1 + r / 3, labels['111'], **alignment)
    # names of different groups
    if show_names:
        plt.text(x1 - r, y1 - r, names[0], fontsize=16, **alignment)
        plt.text(x2 + r, y2 - r, names[1], fontsize=16, **alignment)
        plt.text(x3, y3 + 1.2 * r, names[2], fontsize=16, **alignment)
...
def venn4(data=None, names=None, show_names=True, show_plot=True, **kwds):
    ...
    # names of different groups
    if show_names:
        plt.text(110, 110, names[0], fontsize=16, **alignment)
        plt.text(290, 110, names[1], fontsize=16, **alignment)
        plt.text(130, 275, names[2], fontsize=16, **alignment)
        plt.text(270, 275, names[3], fontsize=16, **alignment)
